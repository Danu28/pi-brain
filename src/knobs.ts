...
export let RECALL_MEMO_MS = 300000;
export let TIER1_LINES = 30;
export let TIER1_RISK = 3;
export let TIER2_LINES = 300;
    ...
    try {
      ...
      for (const [k, v] of Object.entries(raw)) {
        ...
        switch (k) {
          ...
          case "TIER1_LINES": TIER1_LINES = v; applied = true; break;
          case "TIER1_RISK": TIER1_RISK = v; applied = true; break;
          case "TIER2_LINES": TIER2_LINES = v; applied = true; break;
